...
CREATE TABLE `employees` (
  ...
  `basis_of_remuneration` int(11) NOT NULL,
  `employed_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `employees` VALUES (1,'Adam','Kowalski',1,100000,'2007-01-10 00:00:00'),(2,'Adam','Nowak',2,110000,'2017-01-10 00:00:00');
